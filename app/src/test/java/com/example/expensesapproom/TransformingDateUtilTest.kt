...
class TransformingDateUtilTest {
    ...
    @Test
    fun `creating data for the spinner taking February (1 month) and 2022 (year) returns a list with the past six months`(){
    ...
    @Test
    fun `creating data for the spinner taking March (2 month) and 2022 (year) returns a list with the past six months`(){
    ...
    @Test
    fun `creating data for the spinner taking April (3 month) and 2022 (year) returns a list with the past six months`(){
    ...
    @Test
    fun `creating data for the spinner taking Mai (4 month) and 2022 (year) returns a list with the past six months`(){
    ...
    @Test
    fun `creating data for the spinner taking June (5 month) and 2022 (year) returns a list with the past six months`(){
    ...
    @Test
    fun `creating data for the spinner taking July (6 month) and 2022 (year) returns a list with the past six months`(){
    ...
    @Test
    fun `creating data for the spinner taking August (7 month) and 2022 (year) returns a list with the past six months`(){
    ...
    @Test
    fun `creating data for the spinner taking September (8 month) and 2022 (year) returns a list with the past six months`(){
    ...
    @Test
    fun `creating data for the spinner taking October (9 month) and 2022 (year) returns a list with the past six months`(){
    ...
    @Test
    fun `creating data for the spinner taking November (10 month) and 2022 (year) returns a list with the past six months`(){
    ...
    @Test
    fun `creating data for the spinner taking December (11 month) and 2022 (year) returns a list with the past six months`(){
    ...
    @Test
    fun `transforming date from int to string for the spinner taking February (1 month) and 2021 (year) returns a string`(){
        val result = TransformingDateUtil.transformingDateFromIntToString(1,2021)
        assertThat(result).isEqualTo("Feb / 21")
    }
    @Test
    fun `transforming date from int to string for the spinner taking March (2 month) and 2022 (year) returns a string`(){
        val result = TransformingDateUtil.transformingDateFromIntToString(2,2022)
        assertThat(result).isEqualTo("Mar / 22")
    }
    @Test
    fun `transforming date from int to string for the spinner taking April (3 month) and 2022 (year) returns a string`(){
        val result = TransformingDateUtil.transformingDateFromIntToString(3,2022)
        assertThat(result).isEqualTo("Apr / 22")
    }
    @Test
    fun `transforming date from int to string for the spinner taking Mai (4 month) and 2022 (year) returns a string`(){
        val result = TransformingDateUtil.transformingDateFromIntToString(4,2022)
        assertThat(result).isEqualTo("Mai / 22")
    }
    @Test
    fun `transforming date from int to string for the spinner taking June (5 month) and 2022 (year) returns a string`(){
        val result = TransformingDateUtil.transformingDateFromIntToString(5,2022)
        assertThat(result).isEqualTo("Jun / 22")
    }
    @Test
    fun `transforming date from int to string for the spinner taking July (6 month) and 2022 (year) returns a string`(){
        val result = TransformingDateUtil.transformingDateFromIntToString(6,2022)
        assertThat(result).isEqualTo("Jul / 22")
    }
    @Test
    fun `transforming date from int to string for the spinner taking August (7 month) and 2022 (year) returns a string`(){
        val result = TransformingDateUtil.transformingDateFromIntToString(7,2022)
        assertThat(result).isEqualTo("Aug / 22")
    }
    @Test
    fun `transforming date from int to string for the spinner taking September (8 month) and 2022 (year) returns a string`(){
        val result = TransformingDateUtil.transformingDateFromIntToString(8,2022)
        assertThat(result).isEqualTo("Sep / 22")
    }
    @Test
    fun `transforming date from int to string for the spinner taking October (9 month) and 2022 (year) returns a string`(){
        val result = TransformingDateUtil.transformingDateFromIntToString(9,2022)
        assertThat(result).isEqualTo("Oct / 22")
    }
    @Test
    fun `transforming date from int to string for the spinner taking November (10 month) and 2022 (year) returns a string`(){
        val result = TransformingDateUtil.transformingDateFromIntToString(10,2022)
        assertThat(result).isEqualTo("Nov / 22")
    }
    @Test
    fun `transforming date from int to string for the spinner taking December (11 month) and 2022 (year) returns a string`(){
    ...
    @Test
    fun `transforming input from spinner Jan 21 returns a string with 01-2021`(){
    ...
    @Test
    fun `formatting month from spinner input Jan 22 returns a string with Jan`(){
    ...
    @Test
    fun `formatting year from spinner input Jan 23 returns a string with 23`(){
